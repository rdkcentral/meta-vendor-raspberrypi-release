...
| Release Tag   | [Vendor Release 4.11.1](https://github.com/rdkcentral/vendor-manifest-raspberrypi/releases/tag/4.11.1) |
| Yocto Version | kirkstone |
| Date          | 2026-05-12 11:26:16 UTC |

The [Packages And Versions](VendorPackagesAndVersions.md) file provides a table listing vendor-supplied package names and their versions of [Vendor Release 4.11.1](https://github.com/rdkcentral/vendor-manifest-raspberrypi/releases/tag/4.11.1) which aligns with below layer combination.

### Meta-layer Versions
| Layer | Current tag: 4.11.1 | Previous tag: 4.11.0 |
|-------|-----------------------|-----------------------|
...
| meta-oss-vendor-raspberrypi | refs/tags/4.1.6 | refs/tags/4.1.4 |
...
| meta-vendor-raspberrypi-dev | refs/tags/4.11.2 | refs/tags/4.11.0 |
| poky | refs/tags/rdk-4.6.0 | refs/tags/rdk-4.6.0 |
| rdke-common-config | refs/tags/1.0.21 | refs/tags/1.0.20 |
